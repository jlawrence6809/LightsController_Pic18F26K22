...
#define PIN_RESET PORTBbits.RB4
#define PIN_SCE PORTBbits.RB3
#define PIN_DC PORTBbits.RB2
#define PIN_SDIN PORTBbits.RB1
#define PIN_SCLK PORTBbits.RB0
...
/*
var solid = String.fromCharCode(0x2588);
solid += solid;
var empty = "  ";
var str = "\n\n";
for(var y = 0; y < 48; y++){
...
void LCDWrite(uint8_t data_or_command, uint8_t data) {
    ...
    for (uint8_t i = 0; i < 8; i++) {
        ...
        digitalWrite(PIN_SDIN, data & 0x01);
        __delay_us(1);
